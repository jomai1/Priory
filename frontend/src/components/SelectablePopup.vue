...
<script setup>
  ...
  const selectables = {
    "Basic Blocks": [
      { title: "Description Block", image: "/text.png", description: "Add a Description Block"},
      { title: "Image", image: "/image.png", description: "Add a Image" },
      { title: "Todo List", image: "/todo_list.png", description: "Add a Todo List" },
...
.popup-content {
  max-height: calc(90vh - 50px); /* Ensure space for padding and close button */
